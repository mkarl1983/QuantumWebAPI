        ...
        public AllTotals GetRepairOrderTotals()
        {
            ...
            try
            {
                ...
                if(queryResult.Any())
                {
                    ...
                    resultData.TodayTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_UK) || o.SerialNumber.StartsWith(CommonConstants.RO_UK_FRO)) && o.QueryDate.Day == TodayDate.Day && o.QueryDate.Month == TodayDate.Month && o.QueryDate.Year == TodayDate.Year).Select(o => o).Sum(o => o.Total), 0);
                    resultData.MTDTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_UK) || o.SerialNumber.StartsWith(CommonConstants.RO_UK_FRO)) && o.QueryDate >= FirstDayOfMonth(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.YTDTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_UK) || o.SerialNumber.StartsWith(CommonConstants.RO_UK_Old) || o.SerialNumber.StartsWith(CommonConstants.RO_UK_FRO)) && (o.QueryDate >= YTDDate(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now))).Select(o => o).Sum(o => o.Total), 0);
                    resultData.QTDTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_UK) || o.SerialNumber.StartsWith(CommonConstants.RO_UK_Old) || o.SerialNumber.StartsWith(CommonConstants.RO_UK_FRO)) && (o.QueryDate >= GetQuarterStartingDate(DateTime.Now) && o.QueryDate <= GetQuarterEndDate(DateTime.Now))).Select(o => o).Sum(o => o.Total), 0);
                    resultData.LTMTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_UK) || o.SerialNumber.StartsWith(CommonConstants.RO_UK_Old) || o.SerialNumber.StartsWith(CommonConstants.RO_UK_FRO)) && (o.QueryDate >= Last12MonthsDate(DateTime.Now) && o.QueryDate <= DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);

                    resultData.TodayTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_USA) || o.SerialNumber.StartsWith(CommonConstants.RO_USA_BRO)) && o.QueryDate.Day == TodayDate.Day && o.QueryDate.Month == TodayDate.Month  && o.QueryDate.Year == TodayDate.Year).Select(o => o).Sum(o => o.Total), 0);
                    resultData.MTDTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_USA) || o.SerialNumber.StartsWith(CommonConstants.RO_USA_BRO)) && o.QueryDate >= FirstDayOfMonth(DateTime.Now)  && o.QueryDate <= LastDayOfMonth(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.YTDTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_USA) || o.SerialNumber.StartsWith(CommonConstants.RO_USA_BRO))  && o.QueryDate >= YTDDate(DateTime.Now)  && o.QueryDate <= LastDayOfMonth(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.QTDTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_USA) || o.SerialNumber.StartsWith(CommonConstants.RO_USA_BRO))  && o.QueryDate >= GetQuarterStartingDate(DateTime.Now)  && o.QueryDate <= GetQuarterEndDate(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.LTMTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.RO_USA) || o.SerialNumber.StartsWith(CommonConstants.RO_USA_BRO))  && o.QueryDate >= Last12MonthsDate(DateTime.Now)  && o.QueryDate <= DateTime.Now).Select(o => o).Sum(o => o.Total), 0);
            ...
            try
            {
                ...
                if (queryResult.Any())
                {
                   // WriteCSV(queryResult, @"C:\dev\InvoiceTotals.csv");
                    ...
                    resultData.TodayTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_UK) || o.SerialNumber.StartsWith(CommonConstants.INV_UK_FIN)) && o.QueryDate.Day == TodayDate.Day && o.QueryDate.Month == TodayDate.Month && o.QueryDate.Year == TodayDate.Year).Select(o => o).Sum(o => o.Total), 0);
                    resultData.MTDTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_UK) || o.SerialNumber.StartsWith(CommonConstants.INV_UK_FIN)) && o.QueryDate >= FirstDayOfMonth(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.YTDTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_UK) || o.SerialNumber.StartsWith(CommonConstants.INV_UK_FIN) || o.SerialNumber.StartsWith(CommonConstants.INV_UK_Old)) && (o.QueryDate >= YTDDate(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now))).Select(o => o).Sum(o => o.Total), 0);
                    resultData.QTDTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_UK) || o.SerialNumber.StartsWith(CommonConstants.INV_UK_FIN) || o.SerialNumber.StartsWith(CommonConstants.INV_UK_Old)) && (o.QueryDate >= GetQuarterStartingDate(DateTime.Now) && o.QueryDate <= GetQuarterEndDate(DateTime.Now))).Select(o => o).Sum(o => o.Total), 0);
                    resultData.LTMTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_UK) || o.SerialNumber.StartsWith(CommonConstants.INV_UK_FIN) || o.SerialNumber.StartsWith(CommonConstants.INV_UK_Old)) && (o.QueryDate >= Last12MonthsDate(DateTime.Now) && o.QueryDate <= DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);

                    resultData.TodayTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_USA) || o.SerialNumber.StartsWith(CommonConstants.INV_USA_BIN)) && o.QueryDate.Day == TodayDate.Day && o.QueryDate.Month == TodayDate.Month && o.QueryDate.Year == TodayDate.Year).Select(o => o).Sum(o => o.Total), 0);
                    resultData.MTDTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_USA) || o.SerialNumber.StartsWith(CommonConstants.INV_USA_BIN)) && o.QueryDate >= FirstDayOfMonth(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.YTDTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_USA) || o.SerialNumber.StartsWith(CommonConstants.INV_USA_BIN)) && o.QueryDate >= YTDDate(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.QTDTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_USA) || o.SerialNumber.StartsWith(CommonConstants.INV_USA_BIN)) && o.QueryDate >= GetQuarterStartingDate(DateTime.Now) && o.QueryDate <= GetQuarterEndDate(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.LTMTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.INV_USA) || o.SerialNumber.StartsWith(CommonConstants.INV_USA_BIN)) && o.QueryDate >= Last12MonthsDate(DateTime.Now) && o.QueryDate <= DateTime.Now).Select(o => o).Sum(o => o.Total), 0);
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if (queryResult.Any())
                {
                   // WriteCSV(queryResult, @"C:\dev\SalesOrderTotals.csv");
                    ...
                    resultData.TodayTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_UK) || o.SerialNumber.StartsWith(CommonConstants.SO_UK_FSO) ) && o.QueryDate.Day == TodayDate.Day && o.QueryDate.Month == TodayDate.Month && o.QueryDate.Year == TodayDate.Year).Select(o => o).Sum(o => o.Total), 0);
                    resultData.MTDTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_UK) || o.SerialNumber.StartsWith(CommonConstants.SO_UK_FSO)) && o.QueryDate >= FirstDayOfMonth(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.YTDTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_UK) || o.SerialNumber.StartsWith(CommonConstants.SO_UK_Old) || o.SerialNumber.StartsWith(CommonConstants.SO_UK_FSO)) && (o.QueryDate >= YTDDate(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now))).Select(o => o).Sum(o => o.Total), 0);
                    resultData.QTDTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_UK) || o.SerialNumber.StartsWith(CommonConstants.SO_UK_Old) || o.SerialNumber.StartsWith(CommonConstants.SO_UK_FSO)) && (o.QueryDate >= GetQuarterStartingDate(DateTime.Now) && o.QueryDate <= GetQuarterEndDate(DateTime.Now))).Select(o => o).Sum(o => o.Total), 0);
                    resultData.LTMTotals_UK = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_UK) || o.SerialNumber.StartsWith(CommonConstants.SO_UK_Old) || o.SerialNumber.StartsWith(CommonConstants.SO_UK_FSO)) && (o.QueryDate >= Last12MonthsDate(DateTime.Now) && o.QueryDate <= DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);

                    resultData.TodayTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_USA) || o.SerialNumber.StartsWith(CommonConstants.SO_USA_BSO)) && o.QueryDate.Day == TodayDate.Day && o.QueryDate.Month == TodayDate.Month && o.QueryDate.Year == TodayDate.Year).Select(o => o).Sum(o => o.Total), 0);
                    resultData.MTDTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_USA) || o.SerialNumber.StartsWith(CommonConstants.SO_USA_BSO)) && o.QueryDate >= FirstDayOfMonth(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.YTDTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_USA) || o.SerialNumber.StartsWith(CommonConstants.SO_USA_BSO)) && o.QueryDate >= YTDDate(DateTime.Now) && o.QueryDate <= LastDayOfMonth(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.QTDTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_USA) || o.SerialNumber.StartsWith(CommonConstants.SO_USA_BSO)) && o.QueryDate >= GetQuarterStartingDate(DateTime.Now) && o.QueryDate <= GetQuarterEndDate(DateTime.Now)).Select(o => o).Sum(o => o.Total), 0);
                    resultData.LTMTotals_USA = Math.Round(queryResult.Where(o => (o.SerialNumber.StartsWith(CommonConstants.SO_USA) || o.SerialNumber.StartsWith(CommonConstants.SO_USA_BSO)) && o.QueryDate >= Last12MonthsDate(DateTime.Now) && o.QueryDate <= DateTime.Now).Select(o => o).Sum(o => o.Total), 0);
                }
            }
            catch (Exception ex)
            {
