...
namespace QuantumWebAPI.CrystalReports.A2000_QUALITY {
    ...
    public class PO_AND_RO_VENDOR_APPROVALS : ReportClass {
        
        public PO_AND_RO_VENDOR_APPROVALS() {
        }
        
        public override string ResourceName {
            get {
                return "PO AND RO VENDOR APPROVALS.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "QuantumWebAPI.CrystalReports.A2000 QUALITY.PO AND RO VENDOR APPROVALS.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPO_AND_RO_VENDOR_APPROVALS : Component, ICachedReport {
        
        public CachedPO_AND_RO_VENDOR_APPROVALS() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PO_AND_RO_VENDOR_APPROVALS rpt = new PO_AND_RO_VENDOR_APPROVALS();
            rpt.Site = this.Site;
            return rpt;
        }
