...
namespace QuantumWebAPI.CrystalReports.A2000_ACCOUNTS {
    ...
    public class AGED_LISTING_REPORT : ReportClass {
        
        public AGED_LISTING_REPORT() {
        }
        
        public override string ResourceName {
            get {
                return "AGED LISTING REPORT.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "QuantumWebAPI.CrystalReports.A2000 ACCOUNTS.AGED LISTING REPORT.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAGED_LISTING_REPORT : Component, ICachedReport {
        
        public CachedAGED_LISTING_REPORT() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AGED_LISTING_REPORT rpt = new AGED_LISTING_REPORT();
            rpt.Site = this.Site;
            return rpt;
        }
