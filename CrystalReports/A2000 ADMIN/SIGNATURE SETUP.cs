...
namespace QuantumWebAPI.CrystalReports.A2000_ADMIN {
    ...
    public class SIGNATURE_SETUP : ReportClass {
        
        public SIGNATURE_SETUP() {
        }
        
        public override string ResourceName {
            get {
                return "SIGNATURE SETUP.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "QuantumWebAPI.CrystalReports.A2000 ADMIN.SIGNATURE SETUP.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSIGNATURE_SETUP : Component, ICachedReport {
        
        public CachedSIGNATURE_SETUP() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SIGNATURE_SETUP rpt = new SIGNATURE_SETUP();
            rpt.Site = this.Site;
            return rpt;
        }
